## Sequence Low validity note

Keep the fence to the named participants and the messages the source actually
states, in their stated order. Declare participants first, use simple IDs,
