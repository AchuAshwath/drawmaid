 ...
 * while Excalidraw 0.18 ships crowfoot_* names. Unknown arrowheads are
 * silently dropped, turning an ER relationship into a plain line.
 */
const CARDINALITY_TO_EXCALIDRAW: Readonly<Record<string, string>> = {
