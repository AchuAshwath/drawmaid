...
> **Note:** If accessing Drawmaid from `drawmaid.ashwath.space` (or any non-localhost domain), you'll need a CORS-unblock browser extension since local servers don't include CORS headers for cross-origin requests.
